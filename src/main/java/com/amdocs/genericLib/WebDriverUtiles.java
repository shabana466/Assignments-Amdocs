...
public class WebDriverUtiles {
   ...
   /**
    * Note: This method select the redio button.
    * @param : checkBoxWebEelement.
    **/
   public static void selectCheckbox(WebElement checkBoxWebEelement) {
	 boolean flag = checkBoxWebEelement.isSelected(); 
	 if(flag) {
		 Reporter.log("Redio Button is alrady selected");
		 }
	 else {
   ...
   /**
    *Note: This method deselect the checkBox
    * @param Checkbox_WebEelement
    **/
   public void deSelectCheckbox(WebElement checkBoxWebEelement){
	   boolean flag = checkBoxWebEelement.isSelected();
	   if(flag) {
		   checkBoxWebEelement.click();
		  }
